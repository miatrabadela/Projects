...
There are many ways of defusing your bomb. We expect you to be able to explain the functioning of the code in the "bomb" using a combination of GDB debugging skills, an understanding of the assembly code and other data in the bomb files. Each bomb is slightly different from others in an effort to provide you the opportunity to help other students in the class without having all of the work done for you by someone else -- that wouldn't help you learn the material.

## Tools that you're allowed to use.
Here is a list of some of the tools you may find useful in analyzing your bomb, and hints on how to use them. *You can only use the following tools unless you have explicit permission from the TA's or instructor*. Looking for a particular tool? How about documentation? Don’t forget, the commands **apropos**, **man**, and **info** are your friends. In particular, **man ascii** might come in useful. **info gas** will give you more than you ever wanted to know about the GNU Assembler. Also, the web may also be a treasure trove of information. If you get stumped, feel free to ask your instructor or TA for help.
...
[godbolt.org](https://godbolt.org) is a web-based compiler that makes it easy to see the compiled output of code. It can be useful to sketch out your understanding of some code using GodBolt's C/C++ compiler and see if the resulting assembly code is similar to the code in your bomb.
